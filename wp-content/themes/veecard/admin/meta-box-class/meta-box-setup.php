...
if (is_admin()){
 ...
 //Education info meta box config
  ...
  //Skills type info meta box config
	$config4 = array(
    'id' => 'skills_type_info',          		// meta box id, unique per meta box
    'title' => 'Skills Type',          			// meta box title
	  'pages' => array('resume'),      		// post types, accept custom post types as well, default is array('post'); optional
    'context' => 'normal',            		// where the meta box appear: normal (default), advanced, side; optional
    'priority' => 'high',            		// order of meta box: high (default), low; optional
    'fields' => array(),            		// list of meta fields (can be added by field arrays)
  ...
  $my_meta4 =  new AT_Meta_Box($config4);
	...
	//Skills info meta box config
	  ...
	  //Initiate skills info meta box
	  $my_meta41 =  new AT_Meta_Box($config41);

	  //Skills info fields
	  $repeater_fields41[] = $my_meta41->addText($prefix.'skill_name',array('name'=> 'Skill Name '),true);
	  $repeater_fields41[] = $my_meta41->addSelect($prefix.'skill_level',array('1'=>'1','2'=>'2','3'=>'3','41'=>'41','5'=>'5','6'=>'6','7'=>'7','8'=>'8','9'=>'9','10'=>'10'),array('name'=> 'Skill Level ', 'std'=> array('2')),true);

	  //Skills repeater block
	  $my_meta41->addRepeaterBlock($prefix.'skill_',array('inline' => true, 'name' => 'Enter your skill info','fields' => $repeater_fields41, 'sortable'=> true));
  ...
  //Skills info fields
  $repeater_fields4[] = $my_meta4->addText($prefix.'skill_type_name',array('name'=> 'Skill Name '),true);
  $repeater_fields4[] = $my_meta4->addField($prefix.'skills', $my_meta41);

  //Skills repeater block
  $my_meta4->addRepeaterBlock($prefix.'skill_type_',array('inline' => true, 'name' => 'Enter your skill type info','fields' => $repeater_fields4, 'sortable'=> true));
